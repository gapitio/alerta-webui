<template>
  ...
  >
    ...
    <v-list 
      density="compact"
      style="height: calc(100vh - 85px - 130px); overflow-y: auto;"
      slim
    >
    ...
    >
      ...
      <v-col
        class="pt-4 pb-3 border-secondary"
        style="border-top: 1px solid;"
      >
        <img
          v-if="isDark"
          src="@/assets/gapit/gapit-nordics-cts-group-blue-white.svg"
          alt="GapitLogo"
          width="150"
        >
        <img
          v-else
          src="@/assets/gapit/gapit-nordics-cts-group-regular.svg"
          alt="GapitLogo"
          width="150"
        >
      </v-col>
