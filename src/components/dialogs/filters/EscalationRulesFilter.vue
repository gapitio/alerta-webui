...
import type { Filter } from '@/plugins/store/types/escalationRule-types';
...
const filter = computed({
  get: () => store.state.escalationRules.filter,
  set: (val) => store.dispatch('escalationRules/setFilter', val)
})
...
const getRules = () => store.dispatch('escalationRules/getEscalationRules')
