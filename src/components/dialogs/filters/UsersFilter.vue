      ...
      <v-card class="dialog-card">
        ...
        <v-card-text style="overflow-x: hidden">
          <v-row>
            ...
            <v-col cols="12">
              <g-combobox v-model="editedItem.login" show-header :label="t('Login')" clearable multiple />
            </v-col>
            <v-col cols="12">
              <g-combobox v-model="editedItem.email" show-header :label="t('Email')" clearable multiple />
            </v-col>
            <v-col cols="12">
              <g-combobox v-model="editedItem.phoneNumber" show-header :label="t('phoneNumber')" clearable multiple />
            </v-col>
            <v-col cols="12">
              <g-select v-model="editedItem.role" :items="roles" show-header :label="t('Roles')" clearable multiple />
            </v-col>
            <v-col cols="12">
              <g-combobox v-model="editedItem.text" show-header :label="t('Comment')" clearable multiple />
            </v-col>
          </v-row>
        </v-card-text>
