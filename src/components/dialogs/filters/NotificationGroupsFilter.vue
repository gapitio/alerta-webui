      ...
      <v-card class="dialog-card">
        ...
        <v-card-text style="overflow-x: hidden">
          <v-row>
            ...
            <v-col cols="12">
              <g-combobox v-model="editedItem.phoneNumbers" show-header :label="t('PhoneNumbers')" clearable multiple />
            </v-col>
            <v-col cols="12">
              <g-combobox v-model="editedItem.mails" show-header :label="t('Emails')" clearable multiple />
            </v-col>
          </v-row>
        </v-card-text>
