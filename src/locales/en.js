export const en = {
  ...
  NotificationChannelId: 'Name used in Notification Rules to refer to this channel',
  ...
  Verify: 'Verify SSL certificates of host. True/False',
  ...
  Triggers: 'Triggers',
  TriggerInfo: 'Changes in an Alert that trigger an SMS/Email',
  EscalationTriggerInfo: 'Severities that trigger escalation',
  TagsAnd: 'Alert needs all of these tags',
  TagsOr: 'Alert needs one or more of these tags',
