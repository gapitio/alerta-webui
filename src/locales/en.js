export const en = {
  ...
  ExcludedTagsInfo: 'Excluded Tags are organized into groups using a combination of AND and OR logic',
  ...
  ExcludedTagsAnd: 'The AND function represents tags that must all be present to not trigger a notification.',
  ExcludedTagsOr: 'The OR function represents tags where at least one must be present to not trigger a notification.',
  ...
  ExcludedTagsFunctionAnd: 'There is an AND relationship between functions/lists (AND and OR functions must both match to not trigger a notification).',
  TagsGroupsOr: 'There is an OR relationship between groups (if any group matches, a notification is triggered).',
  ExcludedTagsGroupsOr: 'There is an OR relationship between groups (if any group matches, the notification is not triggered).',
  TagGroup: 'triggers notification if the incoming alert has:',
  ExcludedTagGroup: 'do not trigger notification if incoming alert has:',
  ...
  StartTimeInfo: 'Time of day that the rule starts sending notifications. If Start and End is empty the rule sends notificatoin all day',
  EndTimeInfo: 'Time of day that the rule stops sending notifications. If Start and End is empty the rule sends notificatoin all day',
  RepeatDays: 'Days',
  RepeatWeeks: 'Weeks',
  RepeatMonths: 'Months',
