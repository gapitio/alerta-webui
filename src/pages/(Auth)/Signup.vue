      ...
      <v-col cols="12" sm="8">
        ...
        <v-form ref="form" @submit.prevent="validate">
          <v-row>
            ...
            <v-col cols="12">
              <g-text-field v-model="text" type="text" show-header :label="t('Description')" />
            </v-col>
...
const rules = {
  ...
  passwordMatch: (v: string) => (v && v == password.value) || t('PasswordNotMatch')
}
...
const checkPage = () => {
  if (!signupEnabled.value) router.push({path: '/'})
}
checkPage()
</script>
