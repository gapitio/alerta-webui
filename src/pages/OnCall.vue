...
const headers = ref<{title: string, key: keyof OnCall | 'actions', info?: string | string[]}[]>([
  ...
  { title: t('StartDate'), key: 'startDate', info: t('StartDateInfo') },
  { title: t('EndDate'), key: 'endDate', info: t('EndDateInfo') },
