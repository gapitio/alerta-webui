<template>
  <h1>
    ...
    <v-btn flat :href="'data:text/csv;,' + report" type="text/csv" download> Export </v-btn>
  </h1>
  <div style="height: 90vh; overflow: auto">
    ...
    <v-tabs-window v-model="currentTab">
      <v-tabs-window-item value="flapping" :transition="false" :reverse-transition="false">
        <top :items="topFlapping" :title="t('Flapping')" :info="t('TopFlappingDescription')" />
      </v-tabs-window-item>
      <v-tabs-window-item value="offenders" :transition="false" :reverse-transition="false">
        <top :items="topOffenders" :title="t('Offenders')" :info="t('TopOffendersDescription')" />
      </v-tabs-window-item>
      <v-tabs-window-item value="standing" :transition="false" :reverse-transition="false">
        <top :items="topStanding" :title="t('Standing')" :info="t('TopStandingDescription')" />
      </v-tabs-window-item>
    </v-tabs-window>
  </div>
</template>
